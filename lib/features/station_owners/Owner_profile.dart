...
import 'package:flutter_application_1/features/components/list.dart'; // Ensure this import path is correct
              ...
              children: [
                ...
                ListView(
                  ...
                  children: List.generate(settingList.length, (index) => ListTile(
                    ...
                    title: settingList[index], // Directly using Text widget from settingList
                  )),
                ),
                SizedBox(height: 40),
                GestureDetector(
                  onTap: () {
                    ...
                    showToast(meassage: "Signed Out Successfully");
                  },
                  child: Container(
                    width: 100,
                    height: 45,
